...
backdrop-blur-sm p-2"
	>
		<div class="bg-white dark:bg-dark_white rounded-xl pt-2 shadow-2xl w-72">
			<div class="pb-1 px-2 text-dark dark:text-white border-b-2 border-light_gray dark:border-dark_light_gray flex justify-between">
				...
				{#if followers.length > 0}
					{#each followers as follower}
						<div class="px-2">
							...
							>
								<img class="w-7 h-7 sm:w-12 sm:h-12 object-cover rounded-full bg-light_gray" src={follower.photo_url} alt={follower.username} />
