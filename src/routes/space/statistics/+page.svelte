...
<article
	class="flex gap-3 flex-col bg-white dark:bg-dark_bg dark:text-white px-2 py-4 mt-5 rounded-xl shadow-sm"
>
	...
	{#each data.users as user}
		<a
			...
			class="user-a shadow-sm border bg-dark_white border-light_gray dark:border-dark_light_gray py-2.5 flex items-center gap-1 pl-2 pr-5 rounded-xl hover:shadow-sm"
		>
			<img
